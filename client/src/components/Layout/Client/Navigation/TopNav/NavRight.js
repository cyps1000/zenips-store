      ...
      if (isAdmin) {
        hidden = (
          <div className="user-nav-item">
            <Link to="/dashboard" className="shopping-cart-box">
    ...
    return (
      <div className="toolbar-nav-items">
        <ul>
          <li>
            <Link to="/reviews">
              <i className="far fa-comment" /> Contact us
            </Link>
          </li>
          <li>
            <Link to="/guides">
              <i className="fas fa-envelope" /> Subscribe
            </Link>
          </li>
          <li>
            <MDBDropdown>
          ...
          <li>
            <MDBDropdown>
              ...
              <MDBDropdownMenu className="dropdown-default dropdown-blue" right>
                <MDBDropdownItem href="#!">
                  <div className="shopping-cart-box">
                    You currently have no items in the cart.
                  </div>
                </MDBDropdownItem>
              </MDBDropdownMenu>
            </MDBDropdown>
